...
public class ProductService {
	...
	public Product saveProduct(SalesProduct salesProduct) {
		Product product = Product.builder().category(salesProduct.getCategory()).productCode(salesProduct.getCode())
				.productName(salesProduct.getName()).price(salesProduct.getPrice()).salesProductId(salesProduct.getId())
				.build();
		repo.save(product);
