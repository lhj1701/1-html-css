...
import { saveProfile } from "./profileSlice_이효정";
...
const Profile = () => {
  ...
  const [url, setUrl] = useState<string | undefined>(profile.userImage); // 이미지 url
        ...
        >
          ...
          */}
          <div
            ...
            style={{ backgroundImage: `url(${profile.userImage})` }}
          ></div>
